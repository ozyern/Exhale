...
package com.ozyern.exhale.together
...
sealed interface TogetherClientEvent {
    ...
    data class JoinDecision(
        val decision: com.ozyern.exhale.together.JoinDecision,
    ) : TogetherClientEvent
    ...
    data class HeartbeatPong(
        val pong: com.ozyern.exhale.together.HeartbeatPong,
                ...
                try {
                    while (true) {
                        ...
                        when (message) {
                            ...
                            is com.ozyern.exhale.together.JoinDecision -> {
