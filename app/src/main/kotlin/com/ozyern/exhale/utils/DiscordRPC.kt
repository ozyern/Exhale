...
class DiscordRPC(
    ...
    companion object {
        ...
        private const val APP_ICON_URL = 
            "https://raw.githubusercontent.com/ozyern/Exhale/refs/heads/master/assets/icon.png"
    ...
    suspend fun updateSong(
        ...
        val button2CustomUrl = context.dataStore[DiscordActivityButton2CustomUrlKey] ?: "https://github.com/ozyern/Exhale"
    ...
    suspend fun refreshActivity(song: Song, currentPlaybackTimeMillis: Long, isPaused: Boolean = false) = runCatching {
        try {
            ...
            com.ozyern.exhale.utils.GlobalLog.append(
