...
import com.ozyern.exhale.ui.component.PlayerSliderTrack
import com.ozyern.exhale.ui.component.ResizableIconButton
import com.ozyern.exhale.ui.menu.PlayerMenu
import com.ozyern.exhale.ui.theme.PlayerBackgroundColorUtils
    ...
    Column(
        ...
        Row(
            ...
            Column(modifier = Modifier.weight(1f)) {
                ...
                // Premium format badges (Lossless / Hi-Res Lossless / Dolby Atmos)
                // — shown only when the actual stream qualifies.
