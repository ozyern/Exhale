...
import com.ozyern.exhale.widget.PlayerWidgetActions.openAppIntent
...
class ExhalePlayerWidget : GlanceAppWidget() {
    ...
    override suspend fun provideGlance(
        ...
        provideContent {
            ...
            GlanceTheme(colors = ExhaleWidgetColors) {
...
private val ExhaleWidgetColors =
    ColorProviders(
        light =
            lightColorScheme(
