...
package com.ozyern.exhale.lastfm

import com.ozyern.exhale.lastfm.models.Authentication
import com.ozyern.exhale.lastfm.models.LastFmError
import com.ozyern.exhale.lastfm.models.TokenResponse
...
object LastFM {
    ...
    private fun HttpRequestBuilder.lastfmParams(
        ...
        userAgent("Exhale (https://github.com/ozyern/Exhale)")
